...
/**
 * Provides the {@link WebClient} bean used to communicate with OpenAI models.
 */
@Configuration
...
public class OpenAiClientConfiguration {
    ...
    WebClient openAiWebClient(WebClient.Builder builder, OpenAiClientProperties properties) {
